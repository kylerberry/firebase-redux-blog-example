...
export const ATTEMPT_AUTH_PENDING = 'ATTEMPT_AUTH_PENDING'
export const ATTEMPT_AUTH_FULFILLED = 'ATTEMPT_AUTH_FULFILLED'
export const ATTEMPT_AUTH_REJECTED = 'ATTEMPT_AUTH_REJECTED'